    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Coments_Stocks_StockId",
                        column: x => x.StockId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "11111111-1111-1111-1111-111111111111", "a1", "Admin", "ADMIN" },
                    { "22222222-2222-2222-2222-222222222222", "a2", "User", "USER" }
                });
