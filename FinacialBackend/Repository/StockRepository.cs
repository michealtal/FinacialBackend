        ...
        public async Task<List<Stock>> GetAllAsync(QueryObject query)
        {
          ...
          .AsQueryable();
            ...
            if (!string.IsNullOrWhiteSpace(query.SortBy))  
            {
                ...
                //{
                //    stocks = query.IsDescending ? stocks.OrderByDescending(s => s.Symbol) : stocks.OrderBy(s => s.Symbol); // if you have one sortBy object
                //}
                ...
                stocks = query.SortBy.ToLower() switch
                {
                    ...
                    _ => stocks // if SortBy doesn’t match any known field
                };
            }
